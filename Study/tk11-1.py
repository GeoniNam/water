...
w.geometry("500x80")
titleLabel = Label(w, text = "숫자 게임에 오신 것을 환영합니다!", bg = "black")
titleLabel.pack()

guessField = Entry(w)
guessField.pack(side = LEFT)
tryButton = Button(w, text = "시도", fg = "green", bg = "white", command = guessing)
tryButton.pack(side = LEFT)
resultLabel = Label(w, text = "1부터 100사이의 숫자를 입력하시오.", fg = "red",bg = "white")
